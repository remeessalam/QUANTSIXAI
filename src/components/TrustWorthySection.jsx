    ...
    <section className="py-[6rem]">
      <div className="wrapper text-center">
        <h2 data-aos="fade-up" className="heading max-w-6xl mx-auto">
          Empowering Progressive Businesses Across Diverse Industries
        </h2>
        <p data-aos="fade-up" className="description max-w-6xl mx-auto mt-2">
          At QUANTSIX AI, we combine expertise and innovation to deliver tech
          solutions that foster growth, enhance performance, and drive
          transformation.
        </p>
