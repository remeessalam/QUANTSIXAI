        ...
        <div className="wrapper">
          ...
          <div className="grid md:grid-cols-2 gap-5 md:gap-10">
            <p data-aos="fade-right" className="description">
              At [Your Company Name], we believe that technology should be the driving
        ...
        <div className="wrapper flex flex-col items-center gap-5 z-10">
          ...
          >
            ...
            {page === "web-development" &&
              "Your website is the cornerstone of your online presence; ensure it leaves a lasting impression."}
            {page === "app-development" &&
              "In the mobile-first era, a seamless app is vital for boosting user engagement."}
          </h1>
          <p
            data-aos="fade-up"
          ...
          >
            {page === "web-development" &&
              "A great website combines stunning design with seamless functionality, driving engagement and delivering tangible results."}
            {page === "app-development" &&
              "Our apps are crafted to enhance efficiency, elevate user engagement, and empower your business in a mobile-driven world."}
          </p>
